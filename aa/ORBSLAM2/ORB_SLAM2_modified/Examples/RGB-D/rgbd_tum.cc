...
int main(int argc, char **argv)
{
    ...
    //ofstream out("/home/ubuntu/data.txt", ostream::app);
    ...
    for(int ni=0; ni<nImages; ni++)
    {
        ...
        // for ( int m=0; m<imSemantic.rows; m++ )
        // {
        //   for ( int n=0; n<imSemantic.cols; n++ )
        //   {
        //     cv::Vec3b vec_3 = imSemantic.at<cv::Vec3b>(m, n);
        //     int b = vec_3[0];
        //     int g = vec_3[1];
        //     int r = vec_3[2];
        //     out << "B:"<<b<< " G:" << g << " R:" <<r<< endl;
        //   }
        // }
