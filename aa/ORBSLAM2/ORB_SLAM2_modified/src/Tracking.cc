...
cv::Mat Tracking::GrabImageRGBD(const cv::Mat &imRGB,const cv::Mat &imD, const double &timestamp, const cv::Mat &imS)
{
    mImRGB = imRGB;
    mImGray = imRGB;
    mImDepth = imD;
    ...
    mCurrentFrame = Frame(mImGray,mImDepth,timestamp,mpORBextractorLeft,mpORBVocabulary,mK,mDistCoef,mbf,mThDepth, mSemantic);
...
void Tracking::CreateNewKeyFrame()
{
    ...
    mpPointCloudMapping->insertKeyFrame( pKF, this->mImRGB, this->mImDepth, this->mSemantic);
